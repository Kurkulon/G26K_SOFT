...
const FWT_FLTR hR[2] = { FLOAT_FWT( 0.7071067811865476), FLOAT_FWT(0.7071067811865476) };
const FWT_FLTR gR[2] = { FLOAT_FWT( 0.7071067811865476), FLOAT_FWT(-0.7071067811865476) };
...
const FWT_FLTR hR[4] = { FLOAT_FWT( 0.482962913144690),		FLOAT_FWT( 0.836516303737469),	FLOAT_FWT( 0.224143868041857),		FLOAT_FWT(-0.129409522550921)	};
const FWT_FLTR gR[4] = { FLOAT_FWT(-0.129409522550921),		FLOAT_FWT(-0.224143868041857),	FLOAT_FWT( 0.836516303737469),		FLOAT_FWT(-0.482962913144690)	};
...
const FWT_FLTR hF[10] = {	FLOAT_FWT( 0.003335725285002), FLOAT_FWT(-0.012580751999016),
							FLOAT_FWT(-0.006241490213012), FLOAT_FWT( 0.077571493840065),
							FLOAT_FWT(-0.032244869585030), FLOAT_FWT(-0.242294887066190),
							FLOAT_FWT( 0.138428145901103), FLOAT_FWT( 0.724308528438574),
							FLOAT_FWT( 0.603829269797473), FLOAT_FWT( 0.160102397974125)		};

const FWT_FLTR gF[10] = {	FLOAT_FWT(-0.160102397974125), FLOAT_FWT( 0.603829269797473),
							FLOAT_FWT(-0.724308528438574), FLOAT_FWT( 0.138428145901103),
							FLOAT_FWT( 0.242294887066190), FLOAT_FWT(-0.032244869585030),
							FLOAT_FWT(-0.077571493840065), FLOAT_FWT(-0.006241490213012),
...
const FWT_FLTR hR[16] = {	FLOAT_FWT( 0.054415842243082),FLOAT_FWT( 0.312871590914466),FLOAT_FWT( 0.675630736298013),FLOAT_FWT( 0.585354683654869),
							FLOAT_FWT(-0.015829105256024),FLOAT_FWT(-0.284015542962428),FLOAT_FWT( 0.000472484573998),FLOAT_FWT( 0.128747426620186),
							FLOAT_FWT(-0.017369301002022),FLOAT_FWT(-0.044088253931065),FLOAT_FWT( 0.013981027917016),FLOAT_FWT( 0.008746094047016),
							FLOAT_FWT(-0.004870352993011),FLOAT_FWT(-0.000391740372996),FLOAT_FWT( 0.000675449405999),FLOAT_FWT(-0.000117476784002)		};
...
const FWT_FLTR gR[16] = {	FLOAT_FWT(-0.000117476784002),FLOAT_FWT(-0.000675449405999),FLOAT_FWT(-0.000391740372996),FLOAT_FWT( 0.004870352993011),
							FLOAT_FWT( 0.008746094047016),FLOAT_FWT(-0.013981027917016),FLOAT_FWT(-0.044088253931065),FLOAT_FWT( 0.017369301002022),
							FLOAT_FWT( 0.128747426620186),FLOAT_FWT(-0.000472484573998),FLOAT_FWT(-0.284015542962428),FLOAT_FWT( 0.015829105256024),
							FLOAT_FWT( 0.585354683654869),FLOAT_FWT(-0.675630736298013),FLOAT_FWT( 0.312871590914466),FLOAT_FWT(-0.054415842243082)		};


//const FWT_FLTR hF[16] = {	FLOAT_FWT( 0.0544158422),	FLOAT_FWT( 0.3128715909),	FLOAT_FWT(0.6756307363),	FLOAT_FWT( 0.5853546837), 
//							FLOAT_FWT(-0.0158291052),	FLOAT_FWT(-0.2840155430),	FLOAT_FWT(0.0004724846),	FLOAT_FWT( 0.1287474266), 
//							FLOAT_FWT(-0.0173693010),	FLOAT_FWT(-0.0440882539),	FLOAT_FWT(0.0139810279),	FLOAT_FWT( 0.0087460940), 
//							FLOAT_FWT(-0.0048703530),	FLOAT_FWT(-0.0003917404),	FLOAT_FWT(0.0006754494),	FLOAT_FWT(-0.0001174768) };
//
//const FWT_FLTR gF[16] = {	FLOAT_FWT( 0.0001174768),	FLOAT_FWT(0.0006754494),	FLOAT_FWT( 0.0003917404),	FLOAT_FWT(-0.0048703530), 
//							FLOAT_FWT(-0.0087460940),	FLOAT_FWT(0.0139810279),	FLOAT_FWT( 0.0440882539),	FLOAT_FWT(-0.0173693010), 
//							FLOAT_FWT(-0.1287474266),	FLOAT_FWT(0.0004724846),	FLOAT_FWT( 0.2840155430),	FLOAT_FWT(-0.0158291053), 
//							FLOAT_FWT(-0.5853546837),	FLOAT_FWT(0.6756307363),	FLOAT_FWT(-0.3128715909),	FLOAT_FWT( 0.0544158422)};
