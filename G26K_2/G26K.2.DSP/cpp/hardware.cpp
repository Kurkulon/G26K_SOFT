...
volatile u32 shaftCount = 0;
volatile u32 shaftMMSEC = 0;
volatile u32 shaftPrevMMSEC = 0;

volatile u16 motoCount = 0;
volatile u32 rotCount = 0;
volatile u32 rotMMSEC = 0;
volatile u32 rotDeltaMMSEC = 0;

volatile u32 fireSyncCount = 0;
