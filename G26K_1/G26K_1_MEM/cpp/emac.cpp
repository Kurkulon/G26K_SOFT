...
bool InitEMAC()
{
	...
	HW::PIOA->SetWRCONFIG((7<<12)|(1<<15),	PORT_PMUX(11)|PORT_DRVSTR|PORT_WRPINCFG|PORT_PMUXEN|PORT_WRPMUX);
	HW::PIOA->SetWRCONFIG (0x3E<<16,		PORT_PMUX(11)|PORT_DRVSTR|PORT_WRPINCFG|PORT_PMUXEN|PORT_WRPMUX);
