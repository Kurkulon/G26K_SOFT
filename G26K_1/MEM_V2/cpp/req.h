...
__packed struct RspHdr41	// 0xAD41
{
	...
	u16 	sl; 			//7. Длина оцифровки (макс 2028)
	u16 	sd; 			//8. Задержка оцифровки  
	u16		packType;		//9. Упаковка (1 - 4:3 по 12 бит, 2 - 2:1 u-Law, 3 - 4:1 ADPCM по 4 бита)
	u16		packCount;		//10. Количество передаваемых волновых пакетов N
