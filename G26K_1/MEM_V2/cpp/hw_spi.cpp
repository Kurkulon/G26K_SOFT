...
static S_SPIM	spi(SPI_USIC_NUM, PIO_SPCK, PIO_MOSI, PIO_MISO, PIO_CS, PIN_SPCK, PIN_MOSI, PIN_MISO, MUX_SPCK, MUX_MOSI, SPI_CS_PIN, ArraySize(SPI_CS_PIN), &SPI_DMA, SPI_DX0CR, SPI_DX1CR, SYSCLK);
